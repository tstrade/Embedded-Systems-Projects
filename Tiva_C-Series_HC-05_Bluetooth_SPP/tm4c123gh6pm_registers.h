...
const uint32_t  UART_MODUL1_BASE_ADDR = (uint32_t)(0x4000D000);
const uint32_t  UART_MODUL2_BASE_ADDR = (uint32_t)(0x4000E000);
const uint32_t  UART_MODUL3_BASE_ADDR = (uint32_t)(0x4000F000);
const uint32_t  UART_MODUL4_BASE_ADDR = (uint32_t)(0x40010000);
const uint32_t  UART_MODUL5_BASE_ADDR = (uint32_t)(0x40011000);
const uint32_t  UART_MODUL6_BASE_ADDR = (uint32_t)(0x40012000);
const uint32_t  UART_MODUL7_BASE_ADDR = (uint32_t)(0x40013000);
