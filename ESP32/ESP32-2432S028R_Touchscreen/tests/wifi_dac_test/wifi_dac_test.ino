...
const char* ssid     = "Verizon_MX4CL7"; // Change this to your WiFi SSID
const char* password = "repast9-egg-mug"; // Change this to your WiFi password
...
void setup() 
{
  ...
  do
  {
    // Connect to WGRF 97 Rock
    succeeded = audio.connecttohost("https://www.radio.net/s/wgrf");     
    delay(500);
