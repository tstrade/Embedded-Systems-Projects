...
const uint32_t  PRI4                  = (uint32_t)(0x410); // Interrupt 16-19 Priority
const uint32_t  PRI5                  = (uint32_t)(0x414); // Interrupt 20-23 Priority
...
const uint32_t  ADCDCCTL2             = (uint32_t)(0xE0C); // Digital Comparator Control 3
const uint32_t  ADCDCCTL3             = (uint32_t)(0xE10); // Digital Comparator Control 4
const uint32_t  ADCDCCTL4             = (uint32_t)(0xE14); // Digital Comparator Control 5
